...
public class ContextMenu {
	...
	public ContextMenu(Context context, int menuWidth, int animStyle) {
		...
		View view = li.inflate(R.layout.yingyan_widget_context_menu, null);
		
		m_ItemsView = (ListView)view.findViewById(R.id.menuItems);
	...
	{
		this(context, CommonUtils.dip2px(150));
	}
	...
	class ContextMenuAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null)
			{
				convertView=LayoutInflater.from(m_Context).inflate(R.layout.yingyan_widget_context_menu_item, null);
			}
			itemLabel = (TextView)convertView.findViewById(R.id.menuItemLabel);
