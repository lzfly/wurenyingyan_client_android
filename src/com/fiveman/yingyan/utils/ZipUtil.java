...
public class ZipUtil {
	...
	public static boolean upZipSelectedFile(File zipFile, String folderPath,
			String outName, String nameContains) throws ZipException,
			IOException {
	...
	public static Bitmap getBitmapFromZipFile(String file,
				...
				if (ze.isDirectory()) {
					...
					if (ze.getSize() != 0) {
						if (ze.getName().toLowerCase().endsWith(".jpg")
							...
							if (options == null)
								bmp = Bitmap.createBitmap(BitmapFactory
										.decodeStream(zipFile
												.getInputStream(ze)));
							else
								bmp = Bitmap.createBitmap(BitmapFactory
										.decodeStream(
	...
	public static List<ZipPictureBean> getPicturesFromZip(String file,
			BitmapFactory.Options options) throws Exception {
		ZipFile zipFile = null;
		ZipInputStream zin = null;
		InputStream in = null;
	...
	public static Bitmap getPictureItemFromZip(String file,
			BitmapFactory.Options options, String name) throws Exception {
		ZipFile zipFile = null;
		ZipInputStream zin = null;
		InputStream in = null;
		StringBuffer sbf = null;
