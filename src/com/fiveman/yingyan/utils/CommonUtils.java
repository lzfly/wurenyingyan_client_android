...
public class CommonUtils {
	...
	public static int getScreenWidthPx()
	{
		...
		ActivityUtils.getMainActivity().getWindowManager().getDefaultDisplay().getMetrics(dm);
	...
	public static boolean closeInputboard()
	{
		ActivityGroup activity = ActivityUtils.getCurrActivity();
		if (activity != null)
		{
